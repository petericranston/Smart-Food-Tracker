...
export default function RecipesWidget({ dishEmoji, dishName, dishTime, pplServed, numIngredients, isSaved, onToggleSave, onPress }){

    return(
        <TouchableOpacity onPress={onPress} style={{ width: "95%" }} activeOpacity={0.85}>
